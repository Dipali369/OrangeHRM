...
class ElementActions():
    ...
    @staticmethod
    def input_text(element:webelement, wait, text, driver, logger):
    ...
    @staticmethod
    def verifyText_click(element:webelement,wait,driver, text:str, logger):
        wait.until(EC.element_to_be_clickable(element))
    ...
    @staticmethod
    def click(element:webelement,wait):
        wait.until(EC.element_to_be_clickable(element))
        element.click()

    @staticmethod
    def verifyTooltip_click(element:webelement,wait, driver, tooltip:str, attributeName:str):
        wait.until(EC.element_to_be_clickable(element))
    ...
    @staticmethod
    def isSelected(element:webelement, wait, logger, driver, visibleText:str):
        status = None
        wait.until(EC.element_to_be_clickable(element))
    ...
    @staticmethod
    def selectFromDropDownUsingText(element:webelement, wait, logger, visibleText:str):
        wait.until(EC.element_to_be_clickable(element))
    ...
    @staticmethod
    def selectFromDropDownUsingIndex(element:webelement, wait, logger, visibleText:str, index:int):
        wait.until(EC.element_to_be_clickable(element))
        select = Select(element)
        selectedOption = select.first_selected_option
        if selectedOption.text == visibleText:
    ...
    @staticmethod
    def selectFromDropDownUsingValue(element:webelement, wait, logger, visibleText:str, value:str):
        wait.until(EC.element_to_be_clickable(element))
        select = Select(element)
        selectedOption = select.first_selected_option
        if selectedOption.text == visibleText:
    ...
    @staticmethod
    def selectMultipleOptionsFromDropDownUsingValue(element: webelement, wait, logger, visibleText: str, value: str):
        wait.until(EC.element_to_be_clickable(element))
        select = Select(element)
    ...
    @staticmethod
    def selectMultipleOptionsFromDropDownUsingText(element: webelement, wait, logger, visibleText: str):
        wait.until(EC.element_to_be_clickable(element))
        select = Select(element)
        selectedOptions = select.all_selected_options
        for selectedOption in selectedOptions:
    ...
    @staticmethod
    def selectMultipleOptionsFromDropDownUsingIndex(element: webelement, wait, logger, visibleText: str, index:int):
        wait.until(EC.element_to_be_clickable(element))
        select = Select(element)
        selectedOptions = select.all_selected_options
        for selectedOption in selectedOptions:
