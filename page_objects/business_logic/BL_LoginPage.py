...
class LoginPage():
    ...
    def setUsername(self, username:str):
        ...
        EA.input_text(username_txtbox,self.wait, username, self.driver, self.logger)
    ...
    def setPassword(self, password:str):
        ...
        EA.input_text(password_txtbox,self.wait, password, self.driver, self.logger)
    ...
    def clickOnLogin(self):
        ...
        EA.verifyText_click(btn_login,self.wait, self.driver, "Login", self.logger)
